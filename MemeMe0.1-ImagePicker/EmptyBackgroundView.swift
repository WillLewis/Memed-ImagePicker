...
//
//  Created by William Lewis on 10/31/19.
...
class EmptyBackgroundView: UIView {
    ...
    init(image: UIImage, top: String, bottom: String) {
        ...
        setupViews()
        setupImageView(image: UIImage(named: "Docs Icon")!)
        setupLabels(top: "Uh oh Somethings Missing", bottom: "Click the plus sign to add memes")
    }
